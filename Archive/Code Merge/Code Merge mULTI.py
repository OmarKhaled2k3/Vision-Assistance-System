...
def  Money():
    ...
    if result>120:
        ...
        if Match_Count > 24:
            ...
            my_thread = Threader(args=PrintingElement[index_element_arr])
...
def color():
    ...
    for c in cnts1:
        ...
        if area1 > 5000:
            ...
            my_thread = Threader(args="Yellow")
    ...
    for c in cnts4:
        ...
        if area4 > 5000:
            ...
            text_queue.put("Blue")
            #self.my_test = "Blue"
            my_thread = Threader(args="Blue")
#def MainProgram():
    
if __name__ == "__main__":
    manager = multiprocessing.Manager()
    text_queue = manager.Queue()
    #p1 = multiprocessing.Process(target=speaks, args=(text_queue,))
    #a=threading.Thread(target=speaks, args=(text_queue,))
    #a.start()
    #p1.start()
   
    #pool = multiprocessing.Pool()
    #pool.apply_async(speaks, args=(text_queue,))
    '''
    # Creates two processes
    p1 = multiprocessing.Process(target=color)
    p2 = multiprocessing.Process(target=speak)
