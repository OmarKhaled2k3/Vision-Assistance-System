...
def color():
    ...
    lower_yellow = np.array([0,255,165])
    upper_yellow = np.array([40,255,252])

    lower_green = np.array([39,255,20])
    upper_green = np.array([80,255,152])

    lower_red = np.array([0,0,0])
    upper_red = np.array([10,255,255])

    lower_blue = np.array([91,255,150])
